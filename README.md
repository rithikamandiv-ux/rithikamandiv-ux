...
> Building practical software across full-stack development, backend systems, databases, cloud infrastructure, and machine learning.

Software Engineering undergraduate focused on designing and building practical, end-to-end software systems. My work spans modern web applications, REST APIs, relational databases, object-oriented software, cloud infrastructure, and machine learning projects. I focus on understanding the engineering behind the systems I build, with an emphasis on maintainable architecture, clean code, and solving real-world problems.
